...
class GUI:
    def __init__(self):
        ...
        self.limitationsText.insert('end', 'outcomes in other tools for caches near the angle boundaries.\n\n\u2022 ')
        ...
        self.limitationsText.insert('end', '"My Finds" GPX file. Since these are either completed or not (i.e. ')
        self.limitationsText.insert('end', "you can't make partial progress on them), I don't deem it important enough to ")
        self.limitationsText.insert('end', 'make a way for the home coordinates to be entered separately.\n\n\u2022 The ')
        ...
        self.limitationsText.insert('end', 'cache.\n\n\u2022 Grid loops are not reported in the "Way to 81" tables.')
